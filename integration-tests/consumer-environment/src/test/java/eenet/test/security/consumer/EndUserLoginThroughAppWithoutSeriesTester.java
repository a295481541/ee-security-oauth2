...
//	@Test
	public void loginBySMS() {
		...
		appRequest.setAppId(appId);appRequest.setAppSecretKey(appSecret);appRequest.setBizSeriesId(seriesId);
...
//	@Test
	public void loginByAccountFail() {
		...
		SignOnGrant grantObj_1 = userSignOnService.getSignOnGrant(appId, redirectURI, loginAccount, password);
